...
export default function Contribute() {
  return (
    <div>
      ...
      <ProseP className="text-center ">
        Whether that&apos;s contributing a new definition, critiquing an existing one or even suggesting some stylistic
        changes, all valued contributions are welcome through the{" "}
        <Link href="https://github.com/ahmed33033/ai-dictionary" className="underline decoration-2">
          Github Repository
        </Link>
      </ProseP>
    </div>
